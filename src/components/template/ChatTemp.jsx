...
{!projectFiles.loading && projectFiles.files.length > 0 && (
  <div className="flex h-14 items-center justify-end border-b bg-black px-4">
    {/* <Button
      variant="ghost"
  ...
  className="flex items-center gap-2 bg-white text-black hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
  onClick={handleDownload}
>
  {downloading ? (
    <>
