...
export const getProjectsNamesApiForSidebar = async (page = 1, limit = 10, searchTerm = "") => {
  const token = localStorage.getItem("signin_token");
  ...
  const url =
    `https://gateway.codeastra.ai/projects/api/v1/projects/names?page=${page}&limit=${limit}&order_by=desc&name=${searchTerm}`;
